...
(function (root, factory) {
    ...
    //    var gsap = require("gsap/dist/gsap") || require("gsap");
		...
		factory(ScrollMagic, gsap, TweenMax || gsap, TimelineMax || gsap);
	} else {
		// Browser globals
		factory(ScrollMagic || (jQuery && ScrollMagic), gsap, gsap || gsap.TweenMax || gsap.TweenLite, gsap || gsap.TimelineMax || gsap.TimelineLite);
	}
	...
	ScrollMagic.Scene.extend(function () {
		...
		Scene.setTween = function (TweenObject, duration, params) {
			...
			if (parseFloat(gsap.timeline().version) >= 1.14) { // onOverwrite only present since GSAP v1.14.0
				var
